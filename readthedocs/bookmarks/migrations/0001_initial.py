...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bookmarks_bookmark', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bookmarks', null=True, to=orm['projects.Project'])),
    ...
    models = {
        ...
        u'bookmarks.bookmark': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bookmarks'", 'null': 'True', 'to': u"orm['projects.Project']"}),
            'url': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bookmarks'", 'to': u"orm['auth.User']"})
        },
